...
function GRMRPChat.SuppressForeignChat()
    -- Вечер-16: СТАРЫЙ sh_grm_rp_chat/`chat_config` УДАЛЕНЫ из сборки;
    -- префиксы остаются защитой СТАРЫХ установок (аддон-парки без обновы):
    -- цели — «GRM_RPChat*» тех установок и пережитки
