...
- **Часть VII** — GRMRP, собственный игровой режим: принципы, карта систем,
  ...
  от ULib/ULX — указание владельца; сторонние аддоны не переиспользуются).
  В dist-архив аддона не входит — отдельный архив `dist/grmrp_gamemode.zip`
  (собирается tools/build_dist.py; распаковка в `garrysmod/gamemodes/`,
  чеклист 7.4).
