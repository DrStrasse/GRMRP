...
ok(s:find('QM.Version = "5.3.0"',1,true)~=nil,"версия 5.3.0")
...
ok(s:find('Q_BINDS',1,true)~=nil and s:find('GRM_QMenu_QHold',1,true)~=nil and s:find('QM.OpenMenu(true)',1,true)~=nil and s:find('QM.CloseMenu()',1,true)~=nil,"HOLD-Q сохранён (бинд-словарь + Think-фолбэк)")
